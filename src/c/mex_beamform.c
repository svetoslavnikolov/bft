...
#endif 
   printf("\t**************************************************\n");
   printf("\t       Exitting the BeamForming Toolbox\n");
   printf("\t**************************************************\n");
}
...
{ 
  ...
  address = (ui32)floor(mxGetScalar(prhs[1]));
...
void bft_sub_images(int nlhs, mxArray *plhs[],int nrhs, const mxArray *prhs[])
{
  ...
  sub_images(flc, salc, &sys, hi_res, lo_res, element, time, no_samples);
